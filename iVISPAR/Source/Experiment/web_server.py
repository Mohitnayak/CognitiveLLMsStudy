...
async def start_server():
    ...
    server = await websockets.serve(handle_client, "localhost", 1984,max_size=50000000,ping_interval=10, ping_timeout=360)  # Replace "localhost" and 8765 if needed
...
async def start_WebSocket_server():
    ...
    server = await websockets.serve(handle_client, "localhost", 1984, max_size=50000000, ping_interval=10, ping_timeout=360)
    logging.info("WebSocket server started on ws://localhost:1984")

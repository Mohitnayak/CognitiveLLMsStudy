            ...
            for game_num, directory_path in games.items():
                ...
                for json_file in json_files:
                    try:
                        ...
                        # Unity uses this flag to enable/disable the mesh renderers.
                        # Most dataset config files do not set it, which defaults to `false`.
                        config.setdefault("use_rendering", True)
